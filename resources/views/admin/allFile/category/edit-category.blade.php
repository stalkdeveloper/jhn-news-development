            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Category Form <small>Make a news category</small></h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <a href="{{route('getAllCategory')}}" class="btn btn-clean kt-margin-r-10">
                ...
                <div class="kt-portlet__body">
                    <form class="" id="updateCategoryData">
                        @csrf
                            ...
                            <div class="col-xl-8">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        <h3 class="kt-section__title kt-section__title-lg">Caregory Info:</h3>
                                        <div class="form-group row">
                                            <label class="col-3 col-form-label">Title</label>
                                            <div class="col-9">
                                                <input class="form-control" name="category_name" type="text" value="{{$data->title}}" placeholder="Enter your description title" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-3 col-form-label">Description</label>
                                            <div class="col-9">
                                                <textarea class="ckeditor form-control" name="description" value="{{$data->description}}" required>{{$data->description}}</textarea>
...
<script>
    $(document).ready(function() {
        $('#updateCategoryData').submit(function(e) {
            e.preventDefault();
            var formData = new FormData(this);
            $.ajax({
                type:'POST',
                url: "{{route('getUpdateCategory')}}",
                data: formData,
                cache:false,
                contentType: false,
                processData: false,
